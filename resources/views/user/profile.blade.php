        ...
        <div class="nk-content-body">
            <div class="nk-block-head">
                <div class="nk-block-head-content">
                    <div class="nk-block-head-sub"><span><a href="{{route('user.profile')}}">Account Setting</a></span></div>
            ...
            <ul class="nk-nav nav nav-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('user.photo')}}">Profile Picture</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('user.verify.account')}}">KYC Verification</a>
                </li>
                <!--<li class="nav-item">
